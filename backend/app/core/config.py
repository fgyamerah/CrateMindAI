...
# Overridable via environment so deployments are not tied to one machine.
SYNC_SOURCE_LIBRARY: Path = Path(
    os.environ.get("CRATEMINDAI_SYNC_SOURCE_LIBRARY", "/home/koolkatdj/Music/music/library")
)
SYNC_SOURCE_INBOX: Path = Path(
    os.environ.get("CRATEMINDAI_SYNC_SOURCE_INBOX", "/home/koolkatdj/Music/music/inbox")
)
...
SYNC_DEST_SSD: Path = Path(os.environ.get("CRATEMINDAI_SYNC_DEST", "/mnt/music_ssd/KKDJ"))

...
async def list_tracks(
    ...
    has_bpm: Optional[bool] = Query(default=None, description="Filter tracks with or without a BPM"),
    key: Optional[str] = Query(default=None, description="Camelot or musical key (case-insensitive)"),
    folder: Optional[str] = Query(default=None, description="Path prefix under the library root"),
